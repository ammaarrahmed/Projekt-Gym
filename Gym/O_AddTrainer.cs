...
namespace Gym
{
    public partial class O_AddTrainer : Form
    {
        public O_AddTrainer()
        {
            InitializeComponent();
        ...
        {
            string connectionString = "Data Source=SANI-PC\\SQLEXPRESS;Initial Catalog=FLEXTRAINER;Integrated Security=True;Trust Server Certificate=True";
        ...
        private bool AreFieldsEmpty()
        {
            return string.IsNullOrWhiteSpace(fname.Text) || string.IsNullOrWhiteSpace(lname.Text) ||
                   string.IsNullOrWhiteSpace(Dob.Text) || string.IsNullOrWhiteSpace(Dob.Text) ||
                   string.IsNullOrWhiteSpace(comboBox4.Text)
                   || string.IsNullOrWhiteSpace(txtusername.Text) || string.IsNullOrWhiteSpace(lname.Text) ||
        ...
        private void AddTrainerRecord()
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                ...
                using (SqlCommand cmd = new SqlCommand(query, con))
                {
                    ...
                    cmd.Parameters.AddWithValue("@Exp", lname.Text);
                    cmd.Parameters.AddWithValue("@Rating", Dob.Text);
